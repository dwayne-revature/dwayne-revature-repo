...
public class dsController {
	...
	public dsController(dsService rs) {
		this.rs = rs;
	}
	...
	public Handler addReimbursement = (context) -> {
		departmentSupervisor r = gson.fromJson(context.body(), departmentSupervisor.class);
	...
	public Handler approveReimbursement = (ctx) -> {
		...
		departmentSupervisor r = rs.approveReimbursement(id);
