...
//		driver.navigate().refresh(); //Nice.
		 ...
		 * 3 Main Types:
		 * 
		 * 	- Implicit Waits - Will wait up to a given
		 * 		amount of time before throwing an exception.
		 * 	- Explicit Waits - Will wait until a certain
		 * 		condition occurs before proceeding with execution
		 * 	- Fluent Waits - Will wait a maximum amount of time
		 * 		for a condition to occur and will check if the
		 * 		condition appears at regular intervals.
		 */
